...
<body>
    ...
    <div style="border-width: 1px; border-color: black; border-style: double; margin-top: 5px; min-height: 275px;">
        <article style="border: 1px; margin-bottom: 15px; padding: 5px;">
            ...
            <p style="overflow: hidden; text-overflow: ellipsis; text-align: justify;"><?php echo $post->short_description; ?>
            <hr />
            <p style="text-align: right"><?php echo date('d/m/y',strtotime($post->date)); ?> by <?php echo $post->user; ?> <a href="/post/view/<?php echo $post->id; ?>">Read more....</a></p>
        </article>
    </div>
    <?php }?>
